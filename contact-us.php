...
<head>
  ...
  <title>Metassure &#8211; Blockchain base data-exchange marketplace</title>
</head>
...
<body class="dark-theme">
  ...
  <div class="overlay-photo-image-bg parallax" data-bg-img="assets/images/hero/inner-page-hero.jpg" data-bg-opacity="1" style="background-image: url(&quot;assets/images/hero/inner-page-hero.jpg&quot;); opacity: 1;"></div>
        ...
        <nav aria-label="breadcrumb ">
          <ul class="breadcrumb wow fadeInUp" data-wow-delay=".6s">
            <li class="breadcrumb-item">
              <a class="breadcrumb-link" href="#0"><i class="bi bi-house icon"></i>home</a>
            </li>
            ...
            <div class="row">
              <div class="col-12 col-lg-6">
                <div class="info-panel wow fadeInUp" data-wow-delay=".4s ">
                  <h4 class="location-title">Head office</h4>
                  <div class="line-on-side"></div>
                  <p class="location-address">
                  2nd Floor, Eros City Square, Rosewood City Road, Sector 49, Gurugram, Haryana – 122018
                  </p>
                  ...
                  <div class="location-card">
                    ...
                    <div class="card-content">
                      ...
                      <a class="tel link" href="tel:08448850166">+91 8448850166</a>
                    </div>
                  </div>
                </div>
              </div>
              <div class="col-12 col-lg-6">
                <div class="info-panel wow fadeInUp" data-wow-delay=".6s">
                  <h4 class="location-title">Branch</h4>
                  <div class="line-on-side"></div>
                  <p class="location-address">
                  2nd Floor, 3683/7, Narang Colony, Trinagar, Delhi,
North Delhi - 110035
                  </p>
                  <div class="location-card">
                    <i class="flaticon-email icon"></i>
        ...
        <div class="map-box wow fadeInUp" data-wow-delay=".6s">
          <div class="mapouter">
            <div class="gmap_canvas">
              <iframe class="map-iframe" id="gmap_canvas" src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d14036.990135522154!2d77.04493214803503!3d28.411786825147463!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x390d22626d58c223%3A0x73ccb7811917d8d!2sEros%20City%20Square!5e0!3m2!1sen!2sin!4v1696318745987!5m2!1sen!2sin"></iframe>
            </div>
          </div>
        </div>
      </section>
                      ...
                      <div class="col-12 col-lg-6">
                        <div class="input-wrapper">
                          ...
                          <label class="input-label" for="user-name">
                            Name <span class="req">*</span></label><span class="b-border"></span><span class="error-msg"></span>
                        </div>
                      </div>
                      <div class="col-12 col-lg-6">
                        <div class="input-wrapper">
                          ...
                          <label class="input-label" for="user-email">
                            E-mail <span class="req">*</span></label><span class="b-border"></span><span class="error-msg"></span>
                        </div>
                      </div>
                      <div class="col-12">
                        <div class="input-wrapper">
                          ...
                          <label class="input-label" for="msg-subject">
                            Subject <span class="req">*</span></label><span class="b-border"></span><span class="error-msg"></span>
                        </div>
                      </div>
                      <div class="col-12">
                        <div class="input-wrapper">
                          ...
                          <label class="input-label" for="msg-text">
                            your message <span class="req">*</span></label><span class="b-border"></span><i></i><span class="error-msg"></span>
                        </div>
                      </div>
                      <div class="col-12 submit-wrapper">
                        <button class="btn-solid" id="submit-btn" type="submit" name="UserSubmit">
                          Send your message
                        </button>
                      </div>
                    </div>
