...
<head>
    ...
    <title> Verimsart | Motor Insurance</title>
</head>
            ...
            <div class="row align-items-center">
                <div class="col-12 col-lg-6 ">
                    ...
                    <div class="hero-text-area   ">
                        <div class="row">
                            <div class="col-12       ">
                                <div class="pre-title ">Motor Insurance </div>
                                <h1 class="hero-title  "> Your Ultimate Motor <span class="featured-text">Insurance Solution <svg xmlns="http://www.w3.org/2000/svg" class="wavey-underline" width="1104.664" height="100.188" viewBox="0 0 1104.664 100.188">
                            ...
                            <div class="col-10       ">
                                <p class="hero-subtitle ">Drive Worry-Free: Your Road to Safe and Secure Journeys</p>
                            </div>
            ...
            <div class="row">
                ...
                <div class="col-12 col-xl-8  ">
                    <div class="service-content-area">
                        ...
                        <div class="col-12   mx-md-auto col-lg-6 text-center " data-tilt>
                                <div class="hero-image-area mb-5 mb-lg-0">
                                    <div class="hero-img-wraper  "><img class="img-fluid " src="assets/images/services/m1.png" alt="" draggable="false"></div>
                                </div>
                            </div>

                        <div class="service-content">
                            <div class="part">
                                <h2 class="service-title">Motor Insurance Solutions</h2>
                                <p class="service-text">Welcome to our comprehensive Motor Insurance Solutions , where we'll guide you through everything you need to know about protecting your vehicle and ensuring peace of mind on the road. Whether you're a first-time car owner or a seasoned driver, our motor insurance solutions are designed to meet your unique needs and preferences.</p>
                  ...
                  <div class="two-cols-img ">
                    <div class="row">
                      <div class="col-12 col-md-6 mb-3">
                        <div class="img-col"><img class="img-fluid" src="assets/images/services/m2.png" loading="lazy" alt="service single image "></div>
                      </div>
                      <div class="col-12 col-md-6">
                        <div class="img-col"><img class="img-fluid" src="assets/images/services/service-single-img-col-2.jpg" loading="lazy" alt="service single image "></div>
                            ...
                            <div class="part">
                                <h2 class="service-title">Why Motor Insurance Matters:</h2>
                                <p class="service-text">Motor insurance is not just a legal requirement in many countries; it's a crucial tool for safeguarding your investment and ensuring your financial security in the event of unexpected accidents, theft, or damage to your vehicle. With the right motor insurance policy, you can enjoy the freedom of the open road without worrying about potential financial burdens. </p>
                            ...
                            <div class="part">
                                <h2 class="service-title">Our Motor Insurance Solutions:</h2>
                                <p class="service-text">At Verimsart, we understand that every driver and every vehicle is different. That's why we offer a range of tailored motor insurance solutions to suit your specific requirements. Here are some of the key options we provide: </p>
                                        ...
                                        <div class="col-12 col-md-6 ">
                                            <div class="info-item"><span class="info-number ">01.</span>
                                                <div class="info-content">
                                                    <h5 class="info-title">Comprehensive Coverage </h5>
                                                    <p class="info-text">Our comprehensive motor insurance policy covers a wide range of risks, including accidents, theft, fire, vandalism, and more. It's the ultimate protection for your vehicle.</p>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-12 col-md-6 ">
                                            <div class="info-item"><span class="info-number ">02.</span>
                                                <div class="info-content">
                                                    <h5 class="info-title">Third-Party Liability </h5>
                                                    <p class="info-text">This is the minimum coverage required by law in most countries. It covers damage to other people's property or injury to other individuals caused by your vehicle.</p>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-12 col-md-6 ">
                                            <div class="info-item"><span class="info-number ">03.</span>
                                                <div class="info-content">
                                                    <h5 class="info-title">Collision Coverage </h5>
                                                    <p class="info-text"> If you're concerned about damage to your own vehicle in an accident, collision coverage can provide peace of mind by covering repair or replacement costs.</p>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-12 col-md-6 ">
                                            <div class="info-item"><span class="info-number ">04.</span>
                                                <div class="info-content">
                                                    <h5 class="info-title">Uninsured/Underinsured Motorist Coverage </h5>
                                                    <p class="info-text">Protects you when you're involved in an accident with a driver who doesn't have insurance or lacks sufficient coverage.</p>
                                                </div>
                                            </div>
                                        </div>

                                        <div class="col-12 col-md-6 ">
                                            <div class="info-item"><span class="info-number ">05.</span>
                                                <div class="info-content">
                                                    <h5 class="info-title">Personal Injury Protection (PIP) </h5>
                                                    <p class="info-text">This coverage can help pay for medical expenses and lost wages for you and your passengers, regardless of who's at fault.</p>
                                                </div>
                                            </div>
                                        </div>

                                        <div class="col-12 col-md-6 ">
                                            <div class="info-item"><span class="info-number ">06.</span>
                                                <div class="info-content">
                                                    <h5 class="info-title">Optional Add-Ons </h5>
                                                    <p class="info-text">We offer various optional add-ons such as roadside assistance, rental car coverage, and more, so you can customize your policy to fit your lifestyle.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="col-12   mx-md-auto col-lg-6 text-center " data-tilt>
                                <div class="hero-image-area mb-5 mb-lg-0">
                                    <div class="hero-img-wraper  "><img class="img-fluid " src="assets/images/services/m2.png" alt="" draggable="false"></div>
                                </div>
                            </div>
                ...
                <div class="col-12 col-xl-4">
                    <div class="service-sidebar ">
                        <div class="sidebar-pane">
                            <h2 class="sidebar-title">upcoming Insurance Services</h2>
                            <ul class="list">
                                <li class="list-item "><i class="flaticon-travel font-icon"></i><a href="#0"> Travel Insurance
                                        <!-- <i class="bi bi-arrow-right icon "></i> -->
                                    </a></li>
                                <li class="list-item"><i class="flaticon-home font-icon"></i><a href="#0"> Home Insurance
                                        <!-- <i class="bi bi-arrow-right icon "></i> -->
                                    </a></li>
                                <li class="list-item"><i class="flaticon-heart font-icon"></i><a href="#0"> Health Insurance
                                        <!-- <i class="bi bi-arrow-right icon "></i> -->
                                    </a></li>
                                <li class="list-item"><i class="flaticon-power font-icon"></i><a href="#0"> Life Insurance
                                        <!-- <i class="bi bi-arrow-right icon "></i> -->
                                    </a></li>
                                <li class="list-item"><i class="flaticon-collection font-icon"></i><a href="#0"> Liability Insurance
                                        <!-- <i class="bi bi-arrow-right icon "></i> -->
                                    </a></li>
