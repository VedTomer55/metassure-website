 <!-- Start  Page hero-->
    <section
      class="page-hero hero-swiper-slider fade-effect d-flex align-items-center"
      id="page-hero"
    >
      ...
      <div class="slider swiper-container">
        <div class="swiper-wrapper">
          ...
          <div class="swiper-slide">
            <div class="slide-bg-img" data-bg-img="assets/images/hero/hero-bg-1.jpg" style="background-image: url(&quot;assets/images/hero/hero-bg-1.jpg&quot;);">
                ...
                <div class="row">
                  ...
                  <div class="col-12 col-md-8 col-lg-7">
                    <h1 class="slide-title">
                      ...
                      ><span class="design-element rounded-shape stripes">
                      </span>
                    </h1>
                  </div>
                  <div class="col-10 col-md-8 col-lg-6">
                    <p class="slide-subtitle">
                    Metassure is a blockchain based secured platform that enables you to exchange data with complete privacy protection and flexibility.
                    </p>
                  </div>
                  <div class="col-12">
          ...
          <!--second slider-->
          <div class="swiper-slide">
            <div class="slide-bg-img" data-bg-img="assets/images/hero/hero-bg-2.jpg" style="background-image: url(&quot;assets/images/hero/hero-bg-2.jpg&quot;);">
              <div class="overlay-color" data-bg-opacity=".35" style="opacity: 0.35;"></div>
            </div>
            <div class="container">
              <div class="hero-text-area content-always-light">
                <div class="row">
                  ...
                  <div class="col-12">
                    <div class="pre-title">Blockchain</div>
                  </div>
                  <div class="col-12 col-md-8 col-lg-7">
                    <h1 class="slide-title">
                   Data Exchange Marketplace
                      <span class="featured-text"
                        ...
                        >
                          ...
                          /></svg></span
                      ><span
                        class="design-element rounded-shape stripes"
                      ></span>
                    </h1>
                  </div>
                  <div class="col-10 col-md-8 col-lg-6">
          ...
          <!--third slider-->
          <div class="swiper-slide">
            <div class="slide-bg-img" data-bg-img="assets/images/hero/hero-bg-3.jpg" style="background-image: url(&quot;assets/images/hero/hero-bg-3.jpg&quot;);">
              <div class="overlay-color" data-bg-opacity=".35" style="opacity: 0.35;"></div>
            </div>
            <div class="container">
              <div class="hero-text-area content-always-light">
                <div class="row">
                  ...
                  <div class="col-12">
                    <div class="pre-title">AdNetwork</div>
                  </div>
                  <div class="col-12 col-md-8 col-lg-7">
                    <h1 class="slide-title">
                  ...
                  <!-- <div class="col-12">
                    <div class="cta-links-area">
                      <a class="btn-solid cta-link cta-link-primary" href="#0"
                        >start now</a
                      ><a class="btn-outline cta-link" href="#0">Contact us</a>
                    </div>
                  </div> -->
                </div>
              </div>
