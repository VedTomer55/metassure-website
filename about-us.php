        ...
        <div class="row">
          <div class="col-12 col-lg-6 d-flex align-items-center order-1 order-lg-0 about-col pad-end  wow fadeInUp " data-wow-delay="0.6s">
            <div class="text-area ">
              ...
              <p class=" about-text">At Metassure, we believe that data is the most valuable asset in the digital world. Data can unlock new opportunities, insights, and innovations for businesses and individuals. However, data also comes with challenges such as privacy, security, compliance, and usability. That’s why we created Metassure, a technical service provider that works on data exchange, digital KYC, and conversational AI systems</p>
        ...
        <div class="row">
          ...
          <div class="col-12 col-md-8  col-lg-4 mx-md-auto ">
            <div class="tm-member-card     wow   fadeInUp" data-wow-delay="0.1s">
              <div class="tm-image js-tilt "><a class="tm-link  " href="team-member.html">
                  <div class="overlay overlay-color"></div><img class="img-fluid parallax-img  " loading="lazy" src="assets/images/our-team/demo.png" alt="Team Member" />
                </a>
              </div>
              <div class="tm-details"><a class="tm-link" href="team-member.html">
                  <h6 class="tm-name">Saurabh Gupta</h6>
                </a><span class="tm-role">CEO & Founder </span></div>
            </div>
          </div>
          ...
          <div class="col-12 col-md-8  col-lg-4 mx-md-auto ">
            <div class="tm-member-card     wow   fadeInUp" data-wow-delay="0.1s">
              ...
              <div class="tm-details"><a class="tm-link" href="team-member.html">
                  <h6 class="tm-name">Piyush Gupta</h6>
                </a><span class="tm-role"> Chief Marketing Officer </span></div>
            </div>
          </div>
          <!--Second Team Member-->
          <div class="col-12 col-md-8  col-lg-4 mx-md-auto ">
            <div class="tm-member-card     wow   fadeInUp" data-wow-delay="0.2s">
              ...
              <div class="tm-details"><a class="tm-link" href="team-member.html">
                  <h6 class="tm-name">Gaurav Gupta</h6>
                </a><span class="tm-role"> Head-Apps & Integration </span></div>
            </div>
          </div>
