        ...
        (l.initialize = function () {
          ...
          (l.getEappsClass = function (e) {
            ...
            return 1 === t.length
              ...
              : t.length > 1
              ? (t.filter(function (e) {
                  return !!~e.indexOf("dolphinchat-app");
                }),
                t[0])
              : void 0;
          }),
          (l.getWidgetIdByElement = function (e) {
            return "div" === e.tagName.toLowerCase()
              ? l.getEappsClass(e).replace("dolphinchat-app-", "")
          ...
          (l.getWidgetsElements = function (e) {
            ...
            var n = Array.prototype.slice.call(
                e.getElementsByTagName("dolphinchat-app")
              ),
              o = Array.prototype.slice.call(
                e.querySelectorAll('*[class^="dolphinchat-app"]')
              ),
              i = o.concat(n);
            return (
              e instanceof HTMLElement &&
                ~e.className.indexOf("dolphinchat-app") &&
                i.push(e),
              i
            );
          }),
          ...
          (l.resetWidget = function (e) {
            var t = function e(t) {
              ...
              return (e.className = "dolphinchat-app-" + t), e;
            };
              ...
              r.open("get", a + "/" + s),
                ...
                (r.onload = function () {
                  ...
                  e.status ||
                    ...
                    console.log();
                    l.loadAssets(["assets/wa_plugin-dev/wachat-1.0.js"]),
    ...
    (function (t) {
      var n = function (e) {
        var n = this,
          o = !1,
          i = [],
          r = t.eappsCustomPlatformUrl || "https://dev.api.dolphinchat.ai";
          ...
          (n.initWidget = function (t, r) {
            if (o) {
              ...
              var a = {
                ...
                widgetId: r.id || null,
                widgetOrigin: "static.dolphinchat.ai",
                showDolphinchatLogo: !r.preferences.hide_dolphinchat_logo,
                owner: r.isOwner,
                platform: r.platform,
          ...
          (n.initToolbar = function (e, t) {
            ...
            n.body.innerHTML =
              '<div class="eapps-widget-toolbar">\n                <div class="eapps-widget-toolbar-panel-wrapper">\n                    <div class="eapps-widget-toolbar-panel-only-you">Panel only seen by widget owner</div>\n                    \n                    <div class="eapps-widget-toolbar-panel">\n                        <a href="'
                ...
                .concat(
                  t.app,
                  "/?utm_source=clients&utm_medium=user-panel&utm_campaign=dolphinchat-icon&utm_content="
                )
